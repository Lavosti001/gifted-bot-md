...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/6a1f7695a59a446d18fbd.jpg" ; // SET LOGO FOR IMAGE 
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "97470463628,923xxxxxxxx";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "Generated by ▪︎■༒𝐋𝐀 𝐕𝐎𝐒𝐓𝐈 ༒■▪︎" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɢɪғᴛᴇᴅ ᴛᴇᴄʜ 』```", //*『sᴜʙsᴄʀɪʙᴇ • ɢɪғᴛᴇᴅ ᴛᴇᴄʜ』*\n https://whatsapp.com/channel/0029VaJmfmTDJ6H7CmuBss0o"),
 
  author : process.env.PACK_AUTHER|| "▪︎■༒𝐋𝐀 𝐕𝐎𝐒𝐓𝐈 ༒■▪︎",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "▪︎■༒𝐋𝐀 𝐕𝐎𝐒𝐓𝐈 ༒■▪︎",
  ownername:process.env.OWNER_NAME|| "▪︎■༒𝐋𝐀 𝐕𝐎𝐒𝐓𝐈 ༒■▪︎",
